...
const FadeGreeting = ({ firstName }) => (
  <h1 className="animate-in fade-in duration-700 text-xl font-black tracking-tight text-slate-950 dark:text-white sm:text-3xl lg:text-4xl" aria-label={`Good to see you, ${firstName}.`}>
    Good to see you, <span className="text-blue-600 dark:text-blue-400">{firstName}</span>.
  </h1>
);
              ...
              {!showAdminSection && <section className="dashboard-hero relative overflow-hidden p-5 sm:p-6 lg:p-7">
                <div className="relative z-10 flex items-center justify-between gap-4">
                  <div className="min-w-0">
                    <FadeGreeting firstName={user?.displayName?.split(' ')[0] || 'there'} />
                  </div>
